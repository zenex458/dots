...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:foreground ,fg4 :background ,"#191919"))))
   `(mode-line-inactive ((,class (:foreground ,"#111111" :background ,"#111111" :weight normal)))) ;;foreground, comment
   ...
   `(org-level-2 ((,class (:bold t :foreground ,"#aaaaff"))))
   `(org-level-3 ((,class (:bold t :foreground ,"#6cb2eb"))))
   `(org-level-4 ((,class (:bold t :foreground ,"#aaaaff"))))
   `(org-level-5 ((,class (:bold t :foreground ,"#6cb2eb"))))
   `(org-level-6 ((,class (:bold t :foreground ,"#aaaaff"))))
   `(org-level-7 ((,class (:bold t :foreground ,"#6cb2eb"))))
   `(org-level-8 ((,class (:bold t :foreground ,"#aaaaff"))))
   ...
   `(org-ellipsis ((,class (:foreground ,"#aaaaff"))))
   ...
   `(info-quoted-name ((,class (:foreground ,"#aaaaff"))))
   `(info-string ((,class (:foreground ,str))))
   `(icompletep-determined ((,class :foreground ,"#aaaaff")))
   `(undo-tree-visualizer-current-face ((,class :foreground ,"#aaaaff")))
   ...
   `(rainbow-delimiters-depth-7-face ((,class :foreground ,"#aaaaff")))
   ...
   `(web-mode-html-tag-face ((,class (:foreground ,"#aaaaff"))))
   ...
   `(sh-quoted-exec ((t (:foreground , "#aaaaff"))))
   ...
   `(elfeed-search-unread-count-face ((t (:foreground ,fg2))))
