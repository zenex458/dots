    ...
    settings = {
      ...
      binds =
        with config.lib.niri.actions;
        {
          ...
          "Mod+W".action = focus-monitor "DP-1";
          "Mod+E".action = focus-monitor "eDP-1";
          "Mod+R".action = focus-monitor "HDMI-A-1";
          "Mod+Shift+W".action = move-column-to-monitor "DP-1";
          "Mod+Shift+E".action = move-column-to-monitor "eDP-1";
          "Mod+Shift+R".action = move-column-to-monitor "HDMI-A-1";
