...
(let* ((plain "#f8f6f2")
  ...
  (custom-theme-set-faces
   ...
   ;; font lock
   `(default ((t (:inherit nil :foreground ,smudge :background ,bg))))
   `(font-lock-builtin-face ((t (:foreground ,plain))))
   `(font-lock-comment-face ((t (:foreground ,mediumgravel))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,mediumgravel))))
   ...
   ;; ui
   `(cursor ((t (:background ,dress))))
   `(region ((t (:foreground nil :background ,"#444444"))))
   ...
   `(mode-line ((t (:box nil :foreground ,smudge :background ,bg))))
   `(mode-line-inactive ((t (:box nil :foreground ,"#444444" :background "#000000"))))
   ...
   ;; show-paren-mode
   `(show-paren-match ((t (:foreground ,dress :background ,plain :bold t))))
